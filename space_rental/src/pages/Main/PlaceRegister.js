...
function PlaceRegister() {
  ...
  return (
    <div className=" wrap max-w-6xl mx-auto my-0 flex flex-col  text-5xl">
      ...
      <div className="pb-24 w-full ">
        ...
        <div className="">
          ...
          <div className="flex items-center">
            ...
            />
            <button className="rounded-[28px] w-36 h-20 bg-white">등록</button>
          </div>
        </div>
      </div>
      <div className="pb-24 w-full ">
          ...
          <div>
            <button
              ...
              className={`text-xl rounded-lg pt-2 pb-1 px-1.5 leading-none mr-3 ${
                options.wifi ? "bg-red-500" : "bg-white"
              }`}
            >
              와이파이
            </button>
            <button
              ...
              className={`text-xl rounded-lg pt-2 pb-1 px-1.5 leading-none mr-3 ${
                options.parking ? "bg-red-500" : "bg-white"
              }`}
            >
              주차가능
            </button>
            <button
              ...
              className={`text-xl rounded-lg pt-2 pb-1 px-1.5 leading-none mr-3 ${
                options.petsAllowed ? "bg-red-500" : "bg-white"
              }`}
            >
              반려동물 동반가능
            </button>
            <button
              ...
              className={`text-xl rounded-lg pt-2 pb-1 px-1.5 leading-none mr-3 ${
                options.noChildren ? "bg-red-500" : "bg-white"
              }`}
            >
              유아 출입 불가
            </button>
            <button
              ...
              className={`text-xl rounded-lg pt-2 pb-1 px-1.5 leading-none mr-3 ${
                options.nonSmoking ? "bg-red-500" : "bg-white"
              }`}
            >
              금연
            </button>
            <button
              ...
              className={`text-xl rounded-lg pt-2 pb-1 px-1.5 leading-none mr-3 ${
                options.foodAllowed ? "bg-red-500" : "bg-white"
              }`}
            >
              음식물 반입 가능
            </button>
            <button
              ...
              className={`text-xl rounded-lg pt-2 pb-1 px-1.5 leading-none mr-3 ${
                options.alcoholAllowed ? "bg-red-500" : "bg-white"
              }`}
            >
              주류 반입 가능
            </button>
            <button
              ...
              className={`text-xl rounded-lg pt-2 pb-1 px-1.5 leading-none mr-3 ${
                options.showerAvailable ? "bg-red-500" : "bg-white"
              }`}
            >
              샤워실 완비
            </button>
            <button
              ...
              className={`text-xl rounded-lg pt-2 pb-1 px-1.5 leading-none mr-3 ${
                options.operational24h ? "bg-red-500" : "bg-white"
              }`}
            >
              24시 운영
            </button>
            <button
              ...
              className={`text-xl rounded-lg pt-2 pb-1 px-1.5 leading-none mr-3 ${
                options.largeScreen ? "bg-red-500" : "bg-white"
              }`}
            >
              대형 스크린
            </button>
      ...
      <div className="pb-24 w-full ">
        <div className="font-light">시간대별 요금을 설정해 주세요</div>
        <div>
          <input type="text" />
        </div>
      </div>
